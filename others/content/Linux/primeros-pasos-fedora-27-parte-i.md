...
Category: Linux
Tags: fedora, consola, fedora27, rpmfusion
Authors: procamora
Slug: primeros-pasos-fedora-27-parte-i
Summary: En esta primera parte pondré todos las librerías y programas que suelo instalar en Fedora 25 con KDE, en la segunda parte haré una configuración del entorno de trabajo (fstab, crontab, .ssh, etc)
Status: 
---
